    ...
    <div className="w-11/12 sm:w-9/12 md:w-8/12 lg:w-6/12 xl:w-8/12 mx-auto p-5 border-2 border-black">
      <form method="POST" action={`http://localhost:8000/newPost/${id}`}>
        <div className="flex">
          ...
          <input type="text" name="description" placeholder={`What's on your mine, ${firstName}`} className="w-full outline-none border-b-2 border-black focus:border-blue-300 hover:border-blue-300 textIndent pr-2 transition-colors" />       
        </div>
